const services = [
  {
    icon: "B12-A5-Emergency-Hotline/assets/emergency.png",
  ...
  {
    icon: "B12-A5-Emergency-Hotline/assets/police.png",
  ...
  {
    icon: "B12-A5-Emergency-Hotline/assets/fire-service.png",
  ...
  {
    icon: "B12-A5-Emergency-Hotline/assets/ambulance.png",
  ...
  {
    icon: "B12-A5-Emergency-Hotline/assets/mother.png",
    name: "Women & Child Helpline",
    sub: "Women & Child Helpline",
    number: "109",
    category: "Help",
  },
  {
    icon: "B12-A5-Emergency-Hotline/assets/justice.png",
  ...
  {
    icon: "B12-A5-Emergency-Hotline/assets/fuse-box.png",
    name: "Electricity Helpline",
    sub: "Electricity Outage",
    number: "16216",
    category: "Electricity",
  },
  {
    icon: "B12-A5-Emergency-Hotline/assets/brac.png",
    name: "Brac Helpline",
    sub: "Brac",
    number: "16445",
    category: "NGO",
  ...
  {
    icon: "B12-A5-Emergency-Hotline/assets/Bangladesh-Railway.png",
    name: "Bangladesh Railway Helpline",
    sub: "Bangladesh Railway",
    number: "163",
    category: "Travel",
  },
];
...
function renderCards() {
  services.forEach((svc) => {
    ...
    node.querySelector('[data-role="category"]').lastElementChild.textContent =
      svc.category;
    node.querySelector(
      ".w-10"
    ).innerHTML = `<img src="${svc.icon}" alt="Service Icon" class="w-6 h-6">`;

    // Apply blue-100 background for Police Helpline icon container
    if (svc.name === "Police Helpline Number") {
      node
        .querySelector('[data-role="icon-container"]')
        .classList.add("bg-blue-100");
    } else {
      node
        .querySelector('[data-role="icon-container"]')
        .classList.add("bg-rose-100");
    }
